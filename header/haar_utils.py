...
def correct_image(image, face_center, eye_centers):
    ...
    if pt0[0] > pt1[0]: pt0, pt1 = pt1, pt0         # 두 좌표 스왑 >> 좌, 우 눈 위치 맞바꿈
