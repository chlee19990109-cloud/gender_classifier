from header.haar_utils import *                   # 검출기 적재 및 전처리 함수
from header.haar_histogram import *               # 히스토그램 비교 관련 함수
...
if faces.any():
    ...
    if len(eyes) == 2:
        ...
        # 결과 출력
        print("입술-얼굴 유사도: %4.2f" % sim[0])   # 입술 vs 얼굴 유사도
        print("윗-귀밑머리 유사도: %4.2f" % sim[1]) # 윗머리 vs 귀밑머리 유사도
    else:
        print("눈 미검출")
else:
    print("얼굴 미검출")